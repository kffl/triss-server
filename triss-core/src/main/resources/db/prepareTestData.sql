...
(
    ...
    instituteID    BIGINT,
    CONSTRAINT institute_employee_fk FOREIGN KEY (instituteID) REFERENCES Institute (id)
);
...
(
    ...
    CONSTRAINT employee_id_fk FOREIGN KEY (employeeID) REFERENCES Employee(eLoginId)
);
...
(
    ...
    CONSTRAINT application_t_fk FOREIGN KEY (applicationID) REFERENCES Application (id)
);
